...
var generateObjectCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		return generator.GenerateValidationObjectFromCRDs(taxonomyObjectGenerateInputPath, taxonomyObjectGenerateOutputPath)
	},
}
...
func init() {
	...
	_ = generateObjectCmd.MarkFlagDirname("out")
}
